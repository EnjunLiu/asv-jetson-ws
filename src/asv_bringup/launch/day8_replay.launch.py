...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("min_frames", default_value="20"),

        Node(
            package="asv_vla",
            executable="replay_episode",
            name="day8_episode_replay",
            output="screen",
            parameters=[{
        ...
        Node(
            package="asv_vla",
            executable="day8_replay_probe",
            name="day8_replay_probe",
            output="screen",
            parameters=[{
                "episode_dir": ParameterValue(
                    episode_dir, value_type=str
                ),
                "min_frames": ParameterValue(min_frames, value_type=int),
                "timeout_sec": 120.0,
                "completion_grace_sec": 5.0,
                "use_sim_time": False,
            }],
        ),
    ])
