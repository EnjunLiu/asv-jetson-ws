...
DEFAULT_MAX_CURVATURE = 2.0  # rad/m — reject sharp turns
...
DEFAULT_COLLISION_MARGIN_M = 1.0  # minimum distance to any entity
...
def _three_point_curvature(
    ...
    if a < FLOAT_TOLERANCE or b < FLOAT_TOLERANCE or c < FLOAT_TOLERANCE:
        return 0.0
