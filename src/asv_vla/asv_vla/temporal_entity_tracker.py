...
try:
    ...
    from asv_jetson_interfaces.msg import Entity, EntityArray
except ModuleNotFoundError:  # Keep pure tracker tests runnable outside ROS.
    rclpy = None
    Node = object
    QoSProfile = ReliabilityPolicy = None
