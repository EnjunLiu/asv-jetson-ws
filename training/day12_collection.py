...
PLAN_SCHEMA_VERSION = "day12_collection_plan_v1"
REPORT_SCHEMA_VERSION = "day12_collection_report_v1"
...
def main() -> int:
    ...
    try:
        ...
        print(f"DAY12_COLLECTION_FAIL: {exc}")
        return 1
    ...
    marker = (
        "DAY12_COLLECTION_PASS"
        if report["passed"]
        else "DAY12_COLLECTION_INCOMPLETE"
    )
    print(
